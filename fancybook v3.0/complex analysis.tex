...
\usepackage{stys/secondtitlepage}
...
%             \end{tikzpicture}
%         };
%         \node[above,font=\sffamily\huge,shift={(.52\linewidth,.5\barwidth)}] (partname) at (hbar) {第\,\zhnumber{\thepart}\,部\,分};
%         \node[below,font=\bfseries\huge,shift={(.29\linewidth,-.8\barwidth)}] (partcontents) at (hbar) {\begin{varwidth}{.9\linewidth}
%             #1
%         \end{varwidth}};
%         \node[below,,font=\itshape\Large,shift={(0\linewidth,-1.4*\barwidth)}] at (hbar) {\ifdefvoid{\@partabstract}{}{\begin{varwidth}{1.2\linewidth}\@partabstract\end{varwidth}}};
%         \node[above,shift={(-.1\linewidth,.8*\barwidth)},opacity=0.4] at (partname) {\ifdefvoid{\@partimage}{}{\includegraphics[width=.5\linewidth]{\@partimage}}};
%     \end{tikzpicture}}
% \makeatother
...
\newcommand{\partpage}[1]{\begin{tcolorbox}[enhanced jigsaw,breakable,square,circular arc,halign=center,valign=center,colback=nuanbai!90!white,boxrule=0pt,fuzzy shadow={-0.8mm}{0.8mm}{0mm}{0.4mm}{white!50!maincolor},%上
fuzzy shadow={0.8mm}{-0.8mm}{0mm}{0.4mm}{fill=black!90!maincolor}%下
...
\newcommand{\chaptertoccode}{{\chaptertocbox{\etocnumber}{\etocname}{\etocpage}\\[-1em]\tikz\draw[thick] (0,0)--++(\linewidth,0);\par}}

\newcommand{\sectiontoccode}{\@dottedtocline{1}{0em}{3.7em}{\etocnumber\enskip\etocname}{\etocpage}}

\newcommand{\subsectiontoccode}{\@dottedtocline{2}{0em}{2.6em}{\etocnumber\enskip\etocname}{\etocpage}}

\newcommand{\subsubsectiontoccode}{\@dottedtocline{3}{0em}{2.6em}{\etocnumber\etocname}{\etocpage}}
